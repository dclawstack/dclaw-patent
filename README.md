...
[![Status](https://img.shields.io/badge/status-P4%20Planned-3B82F6)](https://github.com/dclawstack/dclaw-patent)
[![Stack](https://img.shields.io/badge/stack-Next.js%2014%20%2B%20FastAPI%20%2B%20PostgreSQL-purple)](https://docs.dclawstack.io/apps/patent)

---

## Overview

DClaw Patent is an AI-native legal application. It follows the standard DClaw architecture:
...
DClaw Patent uses the **DKube Design System** with its app-specific brand color.
...
export DATABASE_URL="postgresql+asyncpg://postgres:postgres@localhost:5432/dclaw_patent"
...
```bash
ssh root@your-vps
git clone https://github.com/dclawstack/dclaw-patent.git /opt/dclaw-patent
cd /opt/dclaw-patent
docker compose up -d
```

The app will be available at `https://patent.dclawstack.io`.

### Kubernetes

```bash
cd helm/dclaw-patent
helm dependency build
helm upgrade --install dclaw-patent . \
