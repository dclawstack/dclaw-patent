...
**DClaw Patent** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8065` (FastAPI)
- **Frontend Port:** `3065` (Next.js)
- **Database:** `dclaw_patent` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3065`
